import svgPaths from "./svg-frv9c42num";
...
function Content() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[2px] grow items-start leading-[0] min-h-px min-w-px not-italic relative shrink-0 w-full" data-name="Content">
      <div className="-webkit-box css-7bw9t7 font-['Graphik:Regular',_sans-serif] overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-[rgba(0,0,0,0.64)] w-full">
        <p className="leading-[1.3]">Shop safely</p>
      </div>
      <div className="-webkit-box css-jj9lsh font-['Graphik:Medium',_sans-serif] overflow-ellipsis overflow-hidden relative shrink-0 text-[18px] text-[rgba(0,0,0,0.96)] tracking-[-0.18px] w-full">
        <p className="leading-[1.3]">My Cards</p>
      </div>
    </div>
  );
}
...
export default function VirtualCardWidget() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col items-start overflow-clip relative rounded-[24px] shadow-[0px_1px_0px_0px_#e5e0e8] size-full" data-name="virtual card widget">
      <Top />
      <Bottom />
    </div>
  );
