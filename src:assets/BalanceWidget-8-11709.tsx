import svgPaths from "./svg-2f8ekj8a34";
import { imgGroup, imgGroup1 } from "./svg-h1loz";
...
function Ticker() {
  return (
    <div className="box-border content-stretch flex items-center justify-center pb-0 pt-[4px] px-0 relative shrink-0" data-name="Ticker">
      <div className="css-1lc4t1 flex flex-col font-['Nu_Sans_Text:Semibold',_sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-[rgba(0,0,0,0.64)] text-nowrap tracking-[0.12px] w-[25px]">
        <p className="[white-space-collapse:collapse] leading-[1.3] overflow-ellipsis overflow-hidden">USD</p>
      </div>
    </div>
  );
}
...
function TitleDescription() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Title + Description">
      <div className="-webkit-box css-teon6v font-['Nu_Sans_Display:Medium',_sans-serif] leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[24px] text-[rgba(0,0,0,0.96)] text-nowrap">
        <p className="leading-[1.2] whitespace-pre">$0,000</p>
      </div>
      <Ticker />
    </div>
  );
  ...
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[2px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Content">
      <div className="-webkit-box css-txjoqe font-['Nu_Sans_Text:Regular',_sans-serif] leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-[rgba(0,0,0,0.64)] tracking-[0.12px] w-full">
        <p className="leading-[1.3]">Balance</p>
      </div>
      <TitleDescription />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Right Action">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Right Action">
          <path d={svgPaths.p340e8f00} fill="var(--fill-0, black)" fillOpacity="0.64" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
export default function BalanceWidget() {
  return (
    <div className="bg-white relative rounded-[24px] shadow-[0px_1px_0px_0px_#e5e0e8] size-full" data-name="Balance Widget">
